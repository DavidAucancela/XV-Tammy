...
## Corpus Check
- 76 files · ~256,232 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 440 nodes · 504 edges · 55 communities (25 shown, 30 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cc1fb810`
...
Cohesion: 0.06
Nodes (25): lato, metadata, playfair, Button(), ButtonProps, IconButton(), IconButtonProps, icons (+17 more)

### Community 1 - "Landing Page & Hero"
Cohesion: 0.15
Nodes (12): OpengraphImage(), size, Home(), Recuerdos(), FloatingIcons(), Icon, NAV_LINKS, ScrollProgress() (+4 more)
...
Cohesion: 0.06
Nodes (32): ButterflyHue, ButterflyShape(), Flight, WING_FILLS, ButterflyGame(), CatchableFlight, HUES, makeFlight() (+24 more)
...
- **Why does `getEventDetails()` connect `Landing Page & Hero` to `NPM Scripts`?**
