# Graph Report - XV-Tammy  (2026-07-18)

## Corpus Check
- 72 files · ~253,256 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 415 nodes · 464 edges · 54 communities (24 shown, 30 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.89)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `164ed992`
...
7. `scripts` - 7 edges
8. `useMusicContext()` - 7 edges
9. `getEventDetails()` - 7 edges
10. `ScannerClient()` - 6 edges
...
Cohesion: 0.06
Nodes (24): lato, metadata, playfair, Button(), ButtonProps, IconButton(), IconButtonProps, icons (+16 more)

### Community 1 - "Landing Page & Hero"
Cohesion: 0.09
Nodes (20): OpengraphImage(), size, Home(), Recuerdos(), Flight, WING_FILLS, FloatingIcons(), Icon (+12 more)
...
Cohesion: 0.07
Nodes (26): framer-motion, next, dependencies, framer-motion, next, qrcode, react, react-dom (+18 more)
...
Cohesion: 0.19
Nodes (11): html5-qrcode, html5-qrcode, metadata, CamState, extractToken(), getQueue(), playBeep(), saveQueue() (+3 more)

### Community 10 - "NPM Scripts"
Cohesion: 0.09
Nodes (24): bloomContainer, bloomItem, CLUSTER, CornerFlorals(), LEAF, Piece, ROSE, FallingPetals() (+16 more)
...
## Knowledge Gaps
- **213 isolated node(s):** `nextConfig`, `name`, `version`, `private`, `dev` (+208 more)
...
- **Why does `dependencies` connect `Runtime Deps & QR API` to `QR Scanner`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `Dev Tooling Dependencies` to `Runtime Deps & QR API`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `html5-qrcode` connect `QR Scanner` to `Runtime Deps & QR API`?**
